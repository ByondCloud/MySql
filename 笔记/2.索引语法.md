...
![image-20230417152210820](image/2.%E7%B4%A2%E5%BC%95%E8%AF%AD%E6%B3%95/image-20230417152210820.png)
...
```mysql
create index index_by_name on tb_user(name);
```

2.为手机号设置唯一索引

```mysql
CREATE UNIQUE INDEX index_unique_phone ON tb_user(phone);
```
